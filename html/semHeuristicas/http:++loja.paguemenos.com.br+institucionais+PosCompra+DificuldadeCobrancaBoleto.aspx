...
<head>
    ...
    <script id="rk-tagManager-59535cb65eae4339976ddfdcf22fc2db" type="text/javascript">
...
<!-- End Google Tag Manager -->
    ...
    <form name="form1" method="post" action="./DificuldadeCobrancaBoleto.aspx?tipo=DificuldadeCobrancaBoleto" id="form1">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
...
<!-- FIM COLUNA DA NAVEGACAO PRINCIPAL (DA ESQUERDA) -->
            ...
            <div class="content">
                ...
                <div class="main-content">
                    ...
                    <div class="text">
                        <h2>
                            <span>Dificuldade de Cobrança: Boleto</span>
                        </h2>
                        Texto Dificuldade de Cobrança no Boleto
                    </div>
                </div>
