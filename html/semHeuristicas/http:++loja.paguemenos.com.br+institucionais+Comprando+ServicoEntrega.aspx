...
<head>
    ...
    <script id="rk-tagManager-107c8a8f689a4edf9bf899cd701339f2" type="text/javascript">
...
<!-- End Google Tag Manager -->
    ...
    <form name="form1" method="post" action="./ServicoEntrega.aspx?tipo=ServicoEntrega" id="form1">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
