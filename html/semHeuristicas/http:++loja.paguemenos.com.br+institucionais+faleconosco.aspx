...
<head>
    ...
    <link href="/includes/minify.aspx?forms.css,checkout" rel="stylesheet" type="text/css" media="screen and (min-width: 980px)">
    <link href="/includes/minify.aspx?institutional.css,novos" rel="stylesheet" type="text/css" media="screen and (min-width: 980px)">
    <script id="rk-tagManager-c9f47199fa234c738716052dff60937c" type="text/javascript">
...
<!-- End Google Tag Manager -->
		...
		<form name="frm" method="post" action="./faleconosco.aspx" id="frm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJNTM4MDYzNDgxD2QWAgIBD2QWBAIBD2QWBgIBDxYCHgdWaXNpYmxlaGQCBQ8PFgIeBFRleHQFDSg4NSkzMTMzLTE0MDBkZAITDxYCHwBoZAIMD2QWAmYPDxYCHwBoZGRkGWqbfWlU56l2LqTfxf6U4rFoGaS0eHrciUkM2lYWf8I=" />


<script type="text/javascript" src="/ajaxpro/prototype.ashx"></script>
<script type="text/javascript" src="/ajaxpro/core.ashx"></script>
<script type="text/javascript" src="/ajaxpro/converter.ashx"></script>
<script type="text/javascript" src="/ajaxpro/IKCLojaMaster.institucionais.faleconosco,PagueMenos2016.ashx"></script>
<script type="text/javascript" src="/ajaxpro/IKCLojaMaster.includes.cabecalho,PagueMenos2016.ashx"></script>

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="F788C144" />
 			<div class="wrapper">
    <div id="header">
...
<!-- FIM COLUNA DA NAVEGACAO PRINCIPAL (DA ESQUERDA) -->
				...
				<div class="content">
					...
					<div class="main-content">
					    ...
					    <iframe id="FrameNeoAssist" allowtransparency="true" src="http://paguemenos.neoassist.com/?action=new&amp;th=ecommerce" style="border:none;width:100%;height:623px;" frameborder="0">
			            </iframe>
		                <div class="text" style="display:none">
		                    <h2><span>Fale Conosco</span></h2>
		                    <p>Seu contato é muito importante para nós.</p>
		                    <p>Envie-nos um e-mail preenchendo os campos abaixo, e logo retornaremos o seu contato.</p>
		                    <p><span id="lblMsgErro"></span></p>
    		                <p class="atention">
	                            Por favor, preencher os campos com *
                            </p>
			                <fieldset class="form box">
				                <div class="field full">
					                <label>
						                <span>Assunto<span class="req">*</span>:</span>
					                    <select name="ddlAssunto" id="ddlAssunto" tabindex="1" title="Assunto">
	<option value="">Selecione</option>
	<option value="1">Cr&#237;ticas ou sugest&#245;es</option>
	<option value="2">Elogios e agradecimentos</option>
	<option value="3">D&#250;vidas sobre pedido, pagamento ou prazo de entrega</option>
	<option value="4">Propostas comerciais</option>
	<option value="5">Parcerias na internet</option>
	<option value="6">Cancelamento de Pedido</option>
	<option value="7">Outros</option>

</select>
					                    <span id='spanMsgValidacaoAssunto' class="validacao"></span>
                                    </label>
				                </div>
				                ...
				                <div class="field first">
					                <label>
					                    ...
					                    <input name="txtNome" type="text" maxlength="128" id="txtNome" tabindex="2" title="Nome" onblur="VerificaNome(this);" />
					                    <span id='spanMsgValidacaoNome' class="validacao"></span>
					                </label>
				                </div>
				                <div class="field">
					                <label>
						                <span>Sobrenome:</span>
					                    <input name="txtSobrenome" type="text" maxlength="128" id="txtSobrenome" tabindex="3" title="Sobrenome" />
                                    </label>
				                </div>
				                <div class="field">
					                <label>
						                <span>E-mail<span class="req">*</span>:</span>
					                    <input name="txtEmail" type="text" maxlength="128" id="txtEmail" tabindex="4" title="E-mail" onblur="VerificaEmailFaleConosco();" />									
					                    <span id='spanMsgValidacaoEmail' class="validacao"></span>
					                </label>
				                </div>
				                <div class="field">
					                <label for="none">
						                ...
						                <div class="phone">
						                    <input name="txtDDD" type="text" maxlength="2" id="txtDDD" tabindex="5" class="ddd msk" title="ddd" onblur="VerificaTelefoneFaleConosco();" onkeypress="SomenteNumero(event);" onkeyup="AlterarCampo(this, &#39;2&#39;);" />
					                        <input name="txtTelefone" type="text" maxlength="10" id="txtTelefone" tabindex="6" class="number msk" title="telefone-celular" onblur="VerificaTelefoneFaleConosco();" onkeyup="AlterarCampo(this, &#39;10&#39;);" />
					                        <span id='spanMsgValidacaoTelefone' class="validacao"></span>
						                </div>
						            </label>
				                </div>
				                <div class="field full">
					                <label>
						                <span>Mensagem<span class="req">*</span>:</span>
					                    <textarea name="txtMensagem" rows="10" cols="20" id="txtMensagem" tabindex="7" title="Mensagem" onblur="VerificaMensagem(this);">
</textarea>
					                    <span id='spanMsgValidacaoMensagem' class="validacao"></span>
                                    </label>
				                </div>
				                <div class="actions">
                                    <a id="btnEnviar" tabindex="8" class="btn ir send" href="#" href="javascript:__doPostBack(&#39;btnEnviar&#39;,&#39;&#39;)">Enviar</a>
	                            </div>
		                    </fieldset>
		                </div>
					</div>
...
<!-- Scripts -->
    ...
    <script type="text/javascript">ExisteLojaCodigo();</script>
		...
		<script type="text/javascript" src="http://loja.paguemenos.com.br/includes/minify.aspx?jquerymeiomask.js" charset="iso-8859-1"></script>
		<script type="text/javascript" src="http://loja.paguemenos.com.br/includes/minify.aspx?contact.js,catalogo"></script>
		<script type="text/javascript">
            jQuery(function(){
                jQuery('.msk').setMask();
            });
