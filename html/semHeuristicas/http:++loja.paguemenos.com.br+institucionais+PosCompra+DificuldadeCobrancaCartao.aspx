...
<head>
    ...
    <script id="rk-tagManager-c772b121002b426fa7a5d7f51bf92638" type="text/javascript">
...
<!-- End Google Tag Manager -->
    ...
    <form name="form1" method="post" action="./DificuldadeCobrancaCartao.aspx?tipo=DificuldadeCobrancaCartao" id="form1">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
...
<!-- FIM COLUNA DA NAVEGACAO PRINCIPAL (DA ESQUERDA) -->
            ...
            <div class="content">
                ...
                <div class="main-content">
                    ...
                    <div class="text">
                        <h2>
                            <span>Dificuldade de Cobrança: Cartão</span>
                        </h2>
                        Texto Dificuldade de Cobrança no Cartão
                    </div>
                </div>
