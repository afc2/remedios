...
<head>
    ...
    <script id="rk-tagManager-c09ff33b8d6e4e1e9d7f636df1d57d40" type="text/javascript">
...
<!-- End Google Tag Manager -->
    ...
    <form name="form1" method="post" action="./ComoNavegar.aspx?tipo=ComoNavegar" id="form1">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
