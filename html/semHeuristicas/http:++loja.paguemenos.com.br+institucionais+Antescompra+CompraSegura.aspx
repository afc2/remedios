...
<head>
    ...
    <script id="rk-tagManager-0a1ad2ddccf642ffaa5b2442e4a0e98b" type="text/javascript">
...
<!-- End Google Tag Manager -->
    ...
    <form name="form1" method="post" action="./CompraSegura.aspx?tipo=CompraSegura" id="form1">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
            ...
            <div class="content">
                ...
                <div class="main-content">
                    ...
                    <div class="text">
                        ...
                        <P style="LINE-HEIGHT: normal; MARGIN: 0cm 0cm 0pt; TEXT-AUTOSPACE: ; mso-layout-grid-align: none" class=MsoNormal><B style="mso-bidi-font-weight: normal"><SPAN style="FONT-FAMILY: Courier New">Compra Segura<?xml:namespace prefix = o ns = "urn:schemas-microsoft-com:office:office" /><o:p></o:p></SPAN></B></P>
<P style="LINE-HEIGHT: normal; MARGIN: 0cm 0cm 0pt; TEXT-AUTOSPACE: ; mso-layout-grid-align: none" class=MsoNormal><SPAN style="FONT-FAMILY: Courier New"><SPAN style="mso-spacerun: yes">&nbsp;</SPAN>Compra 100% segura!<o:p></o:p></SPAN></P>
<P style="LINE-HEIGHT: normal; MARGIN: 0cm 0cm 0pt; TEXT-AUTOSPACE: ; mso-layout-grid-align: none" class=MsoNormal><SPAN style="FONT-FAMILY: Courier New">Para garantir uma operação 100% segura, os dados de sua compra são criptografados. A criptografia é um sistema de codificação de informações criado para garantir que ninguém, em nenhuma hipótese, tenha acesso aos seus dados. Nenhuma informação trafega pela rede sem ser criptografada, utilizando os melhores sistemas disponíveis no mercado. A proteção é absoluta.<o:p></o:p></SPAN></P>
<P style="LINE-HEIGHT: normal; MARGIN: 0cm 0cm 0pt; TEXT-AUTOSPACE: ; mso-layout-grid-align: none" class=MsoNormal><SPAN style="FONT-FAMILY: Courier New">A segurança da nossa loja é certificada pela CERTISIGN, a maior autoridade em segurança na Internet. <o:p></o:p></SPAN></P>
                    </div>
                </div>
