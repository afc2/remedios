...
<script src="/Jss/Utils/MasterPage.js"></script>
    ...
    <link href="Jss/fancybox/jquery.fancybox.css" rel="stylesheet" />
    <script type="text/javascript" src="Jss/fancybox/jquery.fancybox-derma.js"></script>

    <script type="text/javascript">
	    $(document).ready(function() {
	        $("#linkCadastroDerma").fancybox({
                
	            'autoDimensions': true,

	        });
	        console.log('facybox aplicado');
	    });
    </script>

    <script src="/Jss/jquery.maskedinput-1.1.4.pack.js"></script>
<script src="/Jss/Default.js"></script>
<script src="/Jss/Utils/CadastroCliente.js"></script>
 <link href="/assets/css/criar-conta.css" rel="stylesheet"/>


<link rel="stylesheet" type="text/css" href="//onofre.resultspage.com/autocomplete/sli-rac.css" /></head>
...
<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="E11A1D7A" />
<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEdAAY0G8XWetShAXiVuEujO08TvGJREAXUqdHbn/uqryQegasCjseFQU1IG6a1QV/1IsPDvqD576IjU8b+VycT56M9G7LOnIlSWhot6/kulMz3Q3iBFD0jpDLNH0593qkGwDMBqozlDxSCXUtGPIQ3akauOgeHcw==" />
    ...
    <center style="width: 100%">
        <div style="width: 940px; height: 551px; background-image: url(../../Imagens/BG_dermaCenter.jpg); background-repeat: no-repeat; margin: 0 auto">
            <div id="meio_dermacenter" style="width: 940px; height: 425px; padding-top: 122px">
                <div id="esq" style="width: 485px; height: 425px; float: left">
                    <div id="tit" style="width: auto; height: 24px; font-family: arial; font-size: 24px; color: #3d9db7; margin: 0 0 33px 21px">Acesse e confira os descontos exclusivos!</div>
                    <div id="form" style="width: auto; height: 44px; clear: both">
                        <div id="txt_prenecha" style="width: 144px; height: 14px; float: left; font-family: arial; font-size: 16px; color: #0d0200; margin-left: 21px; padding-top: 3px"><label for="cphConteudo_txtCPF_CNPJ">Preencha seu CPF</label></div>
                        <div id="inp" style="width: 222px; height: 30px; float: left">
                            <div id="intuptxt" style="width: 156px; height: 30px; float: left">
                                <input name="ctl00$cphConteudo$txtCPF_CNPJ" type="text" id="cphConteudo_txtCPF_CNPJ" class="msk_cpf" onblur="VerifyCPF()" style="width: 146px; height: 25px" /></div>
                            <div id="inputBt" style="width: 66px; height: 29px; float: left">
                                <input type="submit" name="ctl00$cphConteudo$ctl00" value="Entrar" class="btn btn-blue" style="padding: 6px 9px 7px 9px; margin-left: 14px" />
                            </div>
                        </div>
                    </div>
                    <div id="cphConteudo_LinkCadastro" style="width: 201px; height: 11px; margin: 0 0 0 36px; font-family: arial; font-size: 11px; color: #0d0200">Ainda não é cadastrado? <a id="linkCadastroDerma" data-fancybox-type="iframe" href="IntegracaoDerma.aspx" style="text-decoration: underline; color: #0071bd">Cadastre-se</a></div>
                </div>
                <div id="dir" style="width: 442px; height: 425px; float: left">
                    <img src="../../Imagens/produtos_dermaCenter.jpg" width="442px" height="425" alt="" /></div>
            </div>
        </div>
